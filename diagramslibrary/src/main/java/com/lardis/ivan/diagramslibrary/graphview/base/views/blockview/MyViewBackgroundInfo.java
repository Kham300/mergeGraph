package com.lardis.ivan.diagramslibrary.graphview.base.views.blockview;
...
public class MyViewBackgroundInfo extends View {
    ...
    void init() {
        ...
        padding = (int) HelperLayoutClass.dpToPixels(getResources(), 7);
        round = (int) HelperLayoutClass.dpToPixels(getResources(), 7);
